        ...
        <div class="row">
            <div class="col-md-6 col-xl-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.faqs.categories.create')}}" method="post" autocomplete="off">
                            @csrf
            ...
            <div class="col-md-6 col-xl-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.faqs.categories.update')}}" method="post" autocomplete="off">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{route('admin.faqs.categories.delete', $category->id)}}" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
	...
	$(function(){
		$(".edit_btn").click(function(){
            ...
            $.ajax({
                type:"GET",
                data:{id:id_data},
                url:"{{route('admin.faqs.categories.edit')}}",
