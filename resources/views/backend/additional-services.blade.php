    ...
    <div class="row">
        <div class="col-12 mb-4">
            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addModal"><i
                    class="fas fa-plus"></i> New Service</button>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-primary edit_btn"
                                            value="{{ $service->id }}"><i class="fas fa-edit"></i></button>
                                        <a href="#" data-url="{{ route('admin.services.delete', $service->id) }}"
                                            class="btn btn-danger" onclick="confirmAction(this)">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.services.create') }}" method="post" autocomplete="off" id="insertForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputTitle" placeholder="Enter your question"
                                name="inputTitle" value="{{ old('inputTitle') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="selectType" id="selectType">
                                ...
                                <option value="1" {{ old('selectType') == '1' ? 'selected' : '' }}>According to the
                                    DESI</option>
                                <option value="2" {{ old('selectType') == '2' ? 'selected' : '' }}>According to the
                                    Box</option>
                                <option value="3" {{ old('selectType') == '3' ? 'selected' : '' }}>According to the
                                    Product</option>
                                <option value="4" {{ old('selectType') == '4' ? 'selected' : '' }}>According to the
                                    Weight</option>
                                <option value="5" {{ old('selectType') == '5' ? 'selected' : '' }}>According to the
                                    Volume</option>
                                <option value="6" {{ old('selectType') == '6' ? 'selected' : '' }}>According to the
                                    Price</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputPrice" placeholder="Price enter"
                                name="inputPrice" value="{{ old('inputPrice') }}">
    ...
    <div class="modal fade" id="editModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.services.update') }}" method="post" autocomplete="off"
                        id="updateService">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="inputTitle2">Title</label>
                            <input type="text" class="form-control" id="inputTitle2" placeholder="Enter your question"
                                name="inputTitle2" value="{{ old('inputTitle2') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputPrice2" placeholder="Price enter"
                                name="inputPrice2" value="{{ old('inputPrice2') }}">
