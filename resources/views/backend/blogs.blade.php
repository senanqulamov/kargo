			...
			<div class="modal-body">
				<form action="{{route('admin.blogs.create')}}" method="post" autocomplete="off" id="insertForm">
                    ...
                    <div class="form-group">
						...
						<input type="text" class="form-control" id="category" placeholder="Enter blog title" name="category" value="{{old('category')}}">
			...
			<div class="modal-body">
				<form action="{{route('admin.blogs.update')}}" method="post" autocomplete="off" id="updateFaqs">
                    ...
                    <div class="form-group">
						...
						<input type="text" class="form-control" id="categoryInput" placeholder="Enter blog title" name="category" value="{{old('category')}}">
						<span class="text-danger error-text category_error"></span>
					</div>
                    <div class="form-group">
		...
		$(".edit_btn").click(function(){
            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    $("#categoryInput").val(response.data.category);
