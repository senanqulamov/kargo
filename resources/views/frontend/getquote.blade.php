        ...
        <div class="container">
            <form action="{{ route('userpanel.post_special_offer') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row justify-content-center">
                    @if (Auth::user())
                        <button type="submit" class="btn btn-success" style="width: max-content;">Submit</button>
                    @else
                        <a type="button" class="btn btn-primary" style="width: max-content;"
                            href="{{ route('login') }}">Login first
                        </a>
                    @endif
                </div>
            </form>
