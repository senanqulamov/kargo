            ...
            <div class="navigation__data">
                ...
                <div class="navigation__image">
                    <svg width="148" height="46" viewBox="0 0 148 46" fill="none"
                        ...
                        <path d="M103.53 0L115.885 3.53302L104.735 9.95174L105.844 4.56752L103.53 0Z" fill="#ED5A23" />
                        <path
                    ...
                    <div class="navigation container">
                        ...
                        <div style="display:flex;justify-content:center;margin-top:20px;gap:10px;">
                            @if (Auth::user()->is_admin == 1)
                                <a class="btn btn-info" href="{{ route('admin.index') }}" style="font-size:15px;">
                                    Admin Page
                                </a>
                            @endif
                        ...
                        <div class="navigation__data">
                            ...
                            <ul class="navigation__items">
                                <button class="navigation__box">
                                    <li class="navigation__item">
                                        <a href="{{ route('userpanel.mainmenu') }}" class="navigation__link"><i
                                                class="fa-solid fa-house navigation__icon"></i>
                                            <span class="navigation__span ">Main Page</span></a>
                                    </li>
                                </button>
                                ...
                                <button class="navigation__box">
                                    <li class="navigation__item">
                                        <a href="{{ route('userpanel.courier_request') }}" class="navigation__link"><i
                                                class="fa-solid fa-headset navigation__icon"></i>
                                            <span class="navigation__span">Courier Request</span></a>
                                    </li>
                                </button>
                                ...
                                <button class="navigation__box">
                                    <li class="navigation__item">
                                        <a href="{{ route('userpanel.cargo_companies') }}" class="navigation__link"><i
                                                class="fa-solid fa-truck-ramp-box navigation__icon"></i>
                                            <span class="navigation__span">Cargo Companies</span></a>
                                    </li>
                                </button>
                                ...
                                <button class="navigation__box">
                                    <li class="navigation__item">
                                        <a href="{{ route('userpanel.marketplace') }}" class="navigation__link navigation__icon"><i
                                                class="fa-solid fa-store  navigation__icon"></i>
                                            <span class="navigation__span">Marketplace</span></a>
                                    </li>
                                </button>
