...
@section('content')
    ...
    <style>
        ...
        .orders-holder-hm span {
            cursor: pointer;
            transition: 0.6s;
            font-size: 12px;
        }

        .orders-holder-hm span:hover {
            transform: scale(1.1);
            color: black;
        }
    </style>
            ...
            <div class="tab-sections">
                            ...
                            <div class="courier__table--1 mt-4">
                                <table id="example1" class="table table-bordered table-striped" style="with:100%;">
                                    ...
                                    <tbody>
                                        ...
                                        @endphp
                                        @foreach ($courier_requests->whereIn('status', $pending) as $cr_req)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif ($cr_req->status == 'done')
                                                        <span class="badge rounded-pill bg-success">Courier
                                                            Collected</span>
                                                    @endif
                                                </td>
                                                <td>{{ $cr_req->comment ? $cr_req->comment : '---' }}</td>
                                                @php
                                                        ...
                                                        @if ($courier_orders)
                                                            @foreach ($courier_orders as $courier_order)
                                                                <span class="badge rounded-pill bg-info user_id_badge"
                                                                    onclick="window.open('{{ route('userpanel.viewCargoDetails', $courier_order) }}' , '_self')">
                                                                    {{ $courier_order }}
                                                                </span>
                                                            @endforeach
                                                        @else
                ...
                <section class="courier__page tab-col demand-hm">
                    ...
                    <div class="courier__input">
                        ...
                        <form action="{{ route('userpanel.post_courier_request') }}" method="POST">
                            @csrf
                            <div class="row">
                                                ...
                                                @foreach ($orders as $key => $order)
                                                    <div class="checkbox">
                                                        ...
                                                        <label for="checkbox-custom_0{{ $key }}"
                                                            class="checkbox-custom-label ">{{ $order->id }}</label>
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-6 col-12">
                                    ...
                                    <div class="courier__input-box">
                                        ...
                                        <input type="text" class="form-control courier__select" placeholder="Deirvlon"
                                            name="customer_name">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-12">
                                    ...
                                    <div class="courier__input-box">
                                        ...
                                        @endphp
                                        <select class="form-select courier__select" name="country">
                                ...
                                <div class="col-sm-6 col-12">
                                    ...
                                    <div class="courier__input-box">
                                        ...
                                        <input class="form-control courier__select" type="text"
                                ...
                                <div class="col-sm-6 col-12">
                                    ...
                                    <div class="courier__input-box">
                                        ...
                                        <input class="form-control courier__select" type="text" placeholder="216464"
                                            name="zipcode">
                                    </div>
                    ...
                    <div class="courier__input courier__table-box--2">
                        ...
                        <div class="courier--table-2">
                            <div class="courier__table--2 mt-4">
                                <table id="example2" class="table table-bordered table-striped" style="with:100%;">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Status</th>
                                    ...
                                    <tbody>
                                        ...
                                        @endphp
                                        @foreach ($courier_requests->whereIn('status', $cancelled) as $cr_req)
                                            <tr>
                                                <td>{{ $cr_req->id ? $cr_req->id : '---' }}</td>
                                                <td>
                                                    @if ($cr_req->status == 'pending')
