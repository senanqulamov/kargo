...
balanceBox[0].addEventListener("click", function () {
    ...
    customerBox1.style.height = customerBox1.classList.contains("open")
        ? customerBox1.scrollHeight + "px"
        : 0;
...
balanceBox[1].addEventListener("click", function () {
    ...
    customerBox2.style.height = customerBox2.classList.contains("open")
        ? customerBox2.scrollHeight + "px"
        : 0;
